...
Reusable capabilities for the team — written in Cursor's `SKILL.md` format (frontmatter +
instructions). These live in the repo as shared IP/playbooks.

| Skill | Use it for |
|---|---|
| [`ppt/`](ppt/SKILL.md) | Building pitch decks, customer overviews, investor slides |
...
> **To make a skill usable inside Cursor** (not just repo docs), copy or symlink its folder to
> `~/.cursor/skills/<name>/SKILL.md`. Keeping them here lets the whole team version them in Git.
